...
<body id="page-top">
  ...
  <header class="owl-carousel owl-theme masthead">
    <div class="item bg-1">
      <div class="col-lg-12 my-auto">
        <div class="header-content mx-auto text-center">
  ...
  <section class="countdown-container">
    <h3 class="text-center">FALTAN</h3>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8 mx-auto">
          <h2 class="section-heading">Septiembre 25 del 2020, Mar del Plata</h2>
          <p>Queremos invitarte a celebrar este día tan especial junto a nosotros ♥.</p>
          <div class="badges">
            <img src="img/novios/ella.jpg" alt="">
            <i class="fas fa-plus"></i>
            <img src="img/novios/el.jpg" alt="">
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="features" id="informacion">
    <div class="container">
      <div class="section-heading text-center">
        ...
        <p class="text-muted">información importante</p>
        <hr>
      </div>
      
      <h3 class="text-center event">Ceremonia</h3>
      <div class="row">
        <div class="col-lg-4 my-auto d-none d-sm-block">
          <img src="./img/verticals/2.jpg" class="img-fluid" alt="">
        </div>
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="feature-item">
                  ...
                  <!--<h3>Ceremonia</h3>-->
                  <ul class="text-muted">
                    <li>Lunes 24 de Septiembre, 2020</li>
                  </ul>
                </div>
              </div>
              <div class="col-lg-6">
      ...
      <h3 class="text-center event line-space">Fiesta</h3>
      <div class="row">
        <div class="col-lg-8 my-auto">
          <div class="container-fluid">
            <div class="row">
        ...
        <div class="col-lg-4 my-auto d-none d-sm-block">
          <img src="./img/verticals/1.jpg" class="img-fluid" alt="">
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="cta" id="video">
    <div class="cta-content">
      <div class="container">
        <h2>Video<br>Backstage</h2>
        <a href="#contact" class="btn btn-outline btn-xl js-scroll-trigger">Miralo</a>
      </div>
    </div>
  ...
  <section class="contact bg-primary" id="redes">
    <div class="container">
      <h2>J&D
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 text-center">
          <h2>Algunas Fotitos</h2>
          <p>Queremos compartir con vos este momento tan especial.</p>
        </div>
      </div>
      <div class="row">
        <div class="popup-gallery">
          <a href="img/gallery/gallery-1.jpg"><img src="img/gallery/gallery-1.jpg"></a>
          <a href="img/gallery/gallery-2.jpg"><img src="img/gallery/gallery-2.jpg"></a>
          <a href="img/gallery/gallery-3.jpg"><img src="img/gallery/gallery-3.jpg"></a>
          <a href="img/gallery/gallery-4.jpg"><img src="img/gallery/gallery-4.jpg"></a>
          <a href="img/gallery/gallery-5.jpg"><img src="img/gallery/gallery-5.jpg"></a>
          <a href="img/gallery/gallery-6.jpg"><img src="img/gallery/gallery-6.jpg"></a>
          <a href="img/gallery/gallery-7.jpg"><img src="img/gallery/gallery-7.jpg"></a>
          <a href="img/gallery/gallery-8.jpg"><img src="img/gallery/gallery-8.jpg"></a>
          <a href="img/gallery/gallery-9.jpg"><img src="img/gallery/gallery-9.jpg"></a>
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="row">
        <div class="col-md-8 mx-auto">
          ...
          <form id="formAssistence" action="">
              ...
              <button class="btn btn-outline btn-xl js-scroll-trigger">Enviar</button>
          </form>
          <div class="rta"></div>
        </div>
      </div>
